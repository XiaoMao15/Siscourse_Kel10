...
<main>
    ...
    <h1 class="text-center">User Interface & User Experience</h1><br>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX1.jpeg" class="card-img-top" alt="Langkah 1">
                    <div class="card-body">
                        <h6 class="card-title">Materi 1</h6>
                        <p class="card-text">Pendahuluan UI/UX</p>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX2.jpeg" class="card-img-top" alt="Langkah 2">
                    <div class="card-body">
                        <h6 class="card-title">Materi 2</h6>
                        <p class="card-text">Prinsip Dasar Desain UI/UX</p>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX3.jpeg" class="card-img-top" alt="Langkah 3">
                    <div class="card-body">
                        <h6 class="card-title">Materi 3</h6>
                        <p class="card-text">Proses Desain UI/UX</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX4.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 4</h6>
                        <p class="card-text">User Research</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX5.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 5</h6>
                        <p class="card-text">Wireframing & Prototyping</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX6.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 6</h6>
                        <p class="card-text">Interaction Design</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX7.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 7</h6>
                        <p class="card-text">Mobile App & Web Design Guidelines</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX8.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 8</h6>
                        <p class="card-text">Usability & Accessibility</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/UIUX9.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 9</h6>
                        <p class="card-text">User Testing & Feedback</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
