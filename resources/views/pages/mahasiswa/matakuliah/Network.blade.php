        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network1.jpeg" class="card-img-top" alt="Langkah 1">
                    <div class="card-body">
                        <h6 class="card-title">Materi 1</h6>
                        <p class="card-text">Dasar-dasar Jaringan Komputer</p>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network2.jpeg" class="card-img-top" alt="Langkah 2">
                    <div class="card-body">
                        <h6 class="card-title">Materi 2</h6>
                        <p class="card-text">IP Addressing dan Subnetting</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network3.jpeg" class="card-img-top" alt="Langkah 3">
                    <div class="card-body">
                        <h6 class="card-title">Materi 3</h6>
                        <p class="card-text">Konfigurasi Perangkat Jaringan</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network4.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 4</h6>
                        <p class="card-text">Routing dan Switching</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network5.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 5</h6>
                        <p class="card-text">Keamanan Jaringan</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network6.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 6</h6>
                        <p class="card-text">Jaringan Wireless</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/network7.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 7</h6>
                        <p class="card-text">Troubleshooting dan Tools</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
