...
<main>
    ...
    <h1 class="text-center">Data Engineering</h1>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data1.jpeg" class="card-img-top" alt="Langkah 1">
                    <div class="card-body">
                        <h6 class="card-title">Materi 1</h6>
                        <p class="card-text">Basis Data (Database)</p>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data2.jpeg" class="card-img-top" alt="Langkah 2">
                    <div class="card-body">
                        <h6 class="card-title">Materi 2</h6>
                        <p class="card-text">ETL (Extract, Transform, Load)</p>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data3.jpeg" class="card-img-top" alt="Langkah 3">
                    <div class="card-body">
                        <h6 class="card-title">Materi 3</h6>
                        <p class="card-text">Cloud & Big Data Tools</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data4.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 4</h6>
                        <p class="card-text">Data Warehouse & Data Lake</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data5.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 5</h6>
                        <p class="card-text">Monitoring, Testing & Logging</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/data6.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 6</h6>
                        <p class="card-text">Data Security & Governance</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
