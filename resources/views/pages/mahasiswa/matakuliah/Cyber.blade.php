...
<main>
    ...
    <h1 class="text-center">Cyber Security</h1>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/cyber1.jpeg" class="card-img-top" alt="Langkah 1">
                    <div class="card-body">
                        <h6 class="card-title">Materi 1</h6>
                        <p class="card-text">Keamanan Jaringan (Network Security)</p>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/cyber2.jpeg" class="card-img-top" alt="Langkah 2">
                    <div class="card-body">
                        <h6 class="card-title">Materi 2</h6>
                        <p class="card-text">Keamanan Sistem & Autentikasi</p>
            ...
            <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/cyber3.jpeg" class="card-img-top" alt="Langkah 3">
                    <div class="card-body">
                        <h6 class="card-title">Materi 3</h6>
                        <p class="card-text">Etical Hacking & Penetration Testing (Dasar)</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/cyber4.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 4</h6>
                        <p class="card-text">Kriptografi Dasar</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
             ...
             <div class="swiper-slide">
                <div class="card" style="width: 20rem;">
                    <img src="/images/cyber5.jpeg" class="card-img-top" alt="Langkah 4">
                    <div class="card-body">
                        <h6 class="card-title">Materi 5</h6>
                        <p class="card-text"> Tools & Sistem Operasi Penting</p>
                        <a href="#" class="btn btn-sm btn-primary mt-2">Pelajari</a>
                    </div>
                </div>
            </div>
